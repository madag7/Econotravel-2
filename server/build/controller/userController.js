...
var userController = {
    saveUser: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var _a, nombre, email, password, rol, permisos, users, result, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, , 3]);
                    _a = req.body, nombre = _a.nombre, email = _a.email, password = _a.password, rol = _a.rol, permisos = _a.permisos, users = __rest(_a, ["nombre", "email", "password", "rol", "permisos"]);
                    if (!email || !password || !nombre || !rol || !permisos) {
                        res.status(400).send('Falta el correo electrónico o contraseña');
                    }
                    return [4 /*yield*/, userModel_1["default"].saveUser(__assign({ nombre: nombre, email: email, password: password }, users))];
                case 1:
                    result = _b.sent();
                    result
