...
var experienciaController = {
    getAllExperiences: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var experiences, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, experienciaModel_1["default"].getExperiences()];
                case 1:
                    experiences = _a.sent();
    ...
    getOneExperience: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var param, experiences, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    param = req.params['experiencia_id'];
                    return [4 /*yield*/, experienciaModel_1["default"].getOneExperience(param)];
                case 1:
                    experiences = _a.sent();
                    res.json(experiences);
                    return [3 /*break*/, 3];
    ...
    modifExperience: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var _a, img, titulo, descripcion, precio, duracion, accesibilidad, et_ubicacion, et_transporte, et_duracion, experiencias, result, error_4;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, , 3]);
